...
namespace WpfWeatherApplication.Models
{

    /// <summary>
    /// Ниже приведены все классы, сформированные с помощью специальной вставки Json.
    /// Позволяют десереализовать объект при отправке запроса на получение координат города по поисковому запросу. 
    /// </summary>
    public class CityGeoObject
    {
    ...
    public class CityGeoRootObject
    {
        public CityGeoObject[] Property1 { get; set; }
    }
